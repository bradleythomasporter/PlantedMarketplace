...
import { Upload, BarChart2, DollarSign, Package2, Loader2 } from "lucide-react";
...
const plantTemplates = [
  ...
  },
  {
    ...
    data: {
      ...
      edible: false,
      indoor_suitable: true,
      imageUrl: "https://images.unsplash.com/photo-1509937528035-ad76254b0356?auto=format&fit=crop&w=800&q=80",
    }
  }
];
        ...
        <Dialog open={showCsvInstructions} onOpenChange={setShowCsvInstructions}>
          <DialogContent>
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                To import plants in bulk, prepare a CSV file with the following columns:
              </p>
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc pl-6 text-sm space-y-1">
                  <li>image_url (URL to plant image)</li>
